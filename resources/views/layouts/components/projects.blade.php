@foreach ($proyectos as $proyecto)
    ...
    <div class="col-md-6 col-lg-4 mb-5">
        <div class="portfolio-item proj-imgbx mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal{{ $proyecto->id }}">
    ...
    <!-- Portfolio Modal 1-->
    <div class="portfolio-modal modal fade" style="z-index: 5555555" id="portfolioModal{{ $proyecto->id }}" tabindex="-1"
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <img class="img-fluid rounded mb-5" src="{{ $proyecto->imagensec }}" alt="..."
                                    style="max-width: 50%;" />
