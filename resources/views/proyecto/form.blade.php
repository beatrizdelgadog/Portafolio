<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('Imagen Modal') }}
            {{ Form::text('imagensec', $proyecto->imagensec, ['class' => 'form-control' . ($errors->has('imagensec') ? ' is-invalid' : ''), 'placeholder' => 'Imagen Modal']) }}
            {!! $errors->first('imagensec', '<div class="invalid-feedback">:message</div>') !!}
        </div>
